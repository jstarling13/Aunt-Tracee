...
LOCATIONS = [
    {
        'crunchtime_id': '301606',
        'name':          'Canyon Donuts Congress LLC',
        'qb_file':       'PLACEHOLDER',   # fill in on-site: exact path to .qbw file
        'has_baskin':    False,            # confirm on-site: does this store sell Baskin?
    },
    {
    ...
    },
    {
        ...
        'name':          'Canyon Donuts Lantana LLC',
        'qb_file':       'PLACEHOLDER',
        'has_baskin':    False,
    },
    {
        'crunchtime_id': '308635',
        'name':          'Canyon Donuts 10th Ave LLC',
        'qb_file':       'PLACEHOLDER',
        'has_baskin':    False,
    },
    {
        'crunchtime_id': '336834',
        'name':          'Canyon Donuts Jog',
        'qb_file':       'PLACEHOLDER',
        'has_baskin':    False,
    },
    {
        'crunchtime_id': '342498',
        'name':          'Canyon Donuts GC Nassau',
        'qb_file':       'PLACEHOLDER',
        'has_baskin':    False,
    },
    {
    ...
    },
    {
        ...
        'name':          'Canyon Donuts Williston Park',
        'qb_file':       'PLACEHOLDER',
        'has_baskin':    False,
    },
    {
        'crunchtime_id': '308551',
        'name':          'Canyon Donuts Port Washington Inc',
        'qb_file':       'PLACEHOLDER',
        'has_baskin':    False,
    },
    {
        'crunchtime_id': '332029',
        'name':          'Canyon Donuts Shore Road Inc',
        'qb_file':       'PLACEHOLDER',
        'has_baskin':    False,
    },
    {
        'crunchtime_id': '349322',
        'name':          'Canyon Donuts New Hyde Park',
        'qb_file':       'PLACEHOLDER',
        'has_baskin':    False,
    },
    {
    ...
    },
    {
        ...
        'name':          'Canyon Donuts Seaford Inc',
        'qb_file':       'PLACEHOLDER',
        'has_baskin':    False,
    },
]
